...
const cloversRoutes = require("./routes/clovers");
const viralSharesRoutes = require("./routes/viral-shares");
const {
...
app.use("/api/clovers", cloversRoutes);
app.use("/api/viral-shares", viralSharesRoutes);
